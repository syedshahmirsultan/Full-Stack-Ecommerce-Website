            ...
            <div className="flex gap-2 items-center text-lg">
              ...
              <div
                ...
                className="select-none cursor-pointer flex justify-center items-center w-9 h-9 rounded-full border border-gray-800">+</div>
                        ...
                        <button className='flex  bg-slate-900 hover:bg-slate-800 hover:border-slate-800 h-10 w-36 border-2 border-slate-950 rounded-lg '>
<ShoppingCart size={24} className="text-gray-200 place-self-center ml-2  mr-4" />
