...
const NavBar = () => {
    return (
        <section className='flex justify-between drop-shadow-xs pt-6 pb-6  top-0 sticky backdrop-blur-xl transition-colors duration-200 z-50'>
          <div>
       <Link href="/"> <Image src="/images/Logo.png" alt="Logo" width={150} height={150} className='min-w-[20px] min-h-[20px] p-4 lg:p-0'/></Link>
           ...
           <Link href="/allProducts"><li className="p-1 hover:bg-gray-100" >All Products</li></Link>
            ...
            <input placeholder='Search in our store          ' className='border-none focus:outline-none'/>
            </div>
    ...
    <div className="absolute right-0 top-0 bg-red-500 h-4 w-4 text-white rounded-full text-center text-xs">
        0</div>
      </div>
    </div>
