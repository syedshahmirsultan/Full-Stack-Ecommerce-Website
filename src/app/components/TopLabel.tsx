...
const TopLabel = async () => {
 ...
 <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=18&pause=1000&color=4015F7&random=false&width=435&lines=Welcome+to+Shahmir+Ecommerce%2BWebsite+!;Nice+to+meet+you+!;Here+to+provide+you+with+best+services;Find+variety+of+different+products;Signup+to+get+big+deals" alt="Typing SVG" /></a> </div>
