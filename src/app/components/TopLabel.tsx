...
const TopLabel = async () => {
 ...
 <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=15&pause=1000&color=20FFEE&random=false&width=435&lines=Welcome+to+Shahmir+Ecommerce+Website+!;Nice+to+meet+you+!;Here+to+provide+you+with+best+services;Find+variety+of+different+products+!;Signup+to+get+big+deals" alt="Typing SVG" /></a>
 </div>
 <div className="flex justify-stretch md:justify-end gap-x-4  md:pb-2  pl-4 pr-4 pt-2 lg:pr-14">
     { await  user ?  (
    <LogoutLink className=" text-white px-4 py-2 border border-black bg-black rounded-lg text-[14px] hover:bg-slate-700 hover:border-purple-800">Log out</LogoutLink>
